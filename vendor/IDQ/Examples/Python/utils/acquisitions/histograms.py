...
def acquire_histograms(tc, duration_ps: int, bwid: int, bcount: int, hist_numbers: Iterable[int]) -> Dict[int, List[int]]:
    ...
    zmq_exec(tc, f"REC:DURation {duration_ps}")
...
def save_histograms(histograms: Dict[Any, List[int]], bin_width: int, filepath: str, center_bins: bool=True):
